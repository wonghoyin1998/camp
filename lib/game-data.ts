...
export const AFTERNOON_TASKS: TaskDefinition[] = [
  ...
  },
  {
    ...
    capacity: 2,
    mode: "phone",
    tagline: "貨物開局打亂，全隊按互相牽連的限制重組裝船次序。",
    rules: [
      "畫面會打亂 6 件貨物，並顯示多項互相牽連的裝船限制，毋須傳手機。",
      "全隊討論後用上下鍵重排貨物；鎖定前可以任意修改。",
      "提交後只會顯示有幾條限制未符合，不會直接顯示答案。",
    ],
    success: "連續解開 3 張不同的裝船次序卡。",
    reward: { resources: { network: 2 } },
  },
  {
    id: "C1",
...
export const PROPERTY_CHALLENGE_RULE = "第一隊成功完成即可建立紀錄；之後挑戰的隊伍必須嚴格快過現場最快時間才算成功，相同時間不算。";
...
export const PROPERTIES: PropertyDefinition[] = [
  {
    ...
    title: "管道運輸線",
    game: "雙人棒夾運球",
    materials: ["每位參加者 1 支長棒", "軟膠球 1 個", "起點及終點標示"],
    rules: [
      "每人只可使用自己的一支棒，手或身體不可直接接觸球。",
      "每 2 人組成一對，用兩支棒的末端共同夾實個球。",
      "一對隊員夾住球時，兩人雙腳必須留在原位，不能移動。",
      "沒有夾球的隊員可以移到前方接應；全隊以逐對交接方式將球送往終點。",
      "球跌地便放回起點重新運送，計時不會暫停。",
    ],
    success: "全隊將球送過終點而沒有用手接觸；後到隊伍必須快過現場最快時間。",
  },
  {
    id: "P2",
    title: "吊臂堆疊站",
    game: "繩控疊杯",
    materials: ["膠杯 6 個", "橡筋圈 1 個", "每位參加者 1 條控制繩", "目標杯塔圖 1 張"],
    rules: [
      "每人只可握住自己的一條控制繩，不可直接用手碰杯或橡筋圈。",
      "全隊拉緊或放鬆繩索，控制橡筋圈套住、提起及移動膠杯。",
      "依照目標圖將 6 個膠杯疊成完整杯塔。",
      "杯塔倒下或杯跌出指定範圍便在原位重砌，計時不會暫停。",
    ],
    success: "完成與目標圖相同而且能獨立企穩 3 秒的杯塔；後到隊伍必須快過現場最快時間。",
  },
  {
    id: "P3",
    title: "藍圖工房",
    game: "Six Bricks 分散視角砌塔（免費轉產）",
    materials: ["Six Bricks 積木 8–12 粒", "同一座塔的不同視角圖，每人 1 張", "完成模型參考圖 1 張（工作員核對用）"],
    rules: [
      "工作員將同一座塔的正面、背面、左面、右面及頂視圖分派，每人只可看自己的一張圖。",
      "不可向隊友展示或交換視角圖，只可用說話描述自己看到的形狀、顏色及位置。",
      "全隊共同使用 8–12 粒 Six Bricks，按所有人的資料砌出唯一正確的立體模型。",
      "完成後由工作員用參考圖核對；不正確可以繼續修改，計時不會暫停。",
    ],
    success: "模型同時符合全部視角圖；後到隊伍必須快過現場最快時間。",
  },
  {
    id: "P4",
    title: "浮島補給線",
    game: "地墊過河",
    materials: ["防滑地墊 3 塊", "起點及終點標示"],
    rules: [
      "起步後所有隊員只可站在地墊上，身體任何部分不可接觸地面。",
      "全隊合作將最後面的地墊傳到最前面，再逐步向終點移動。",
      "任何隊員碰地，全隊返回起點重新開始，計時不會暫停。",
      "地墊不可拋擲，亦不可在沒有人接住時滑出隊伍範圍。",
    ],
    success: "全隊連同 3 塊地墊完全越過終點；後到隊伍必須快過現場最快時間。",
  },
  {
    id: "P5",
    title: "雙圈穿越線",
    game: "尼龍繩雙圈人體傳送",
    materials: ["已接成圈的尼龍繩圈 2 個"],
    rules: [
      "全隊手牽手圍成一圈，開始後不可鬆手或交換位置。",
      "工作員將兩個尼龍繩圈放在相對位置，兩個繩圈要同時向相反方向傳送。",
      "隊員依次讓繩圈越過頭、身體及雙腳，不可用手解開繩圈。",
      "任何人鬆手，或兩個繩圈纏在一起，全隊回到開始位置重做，計時不會暫停。",
    ],
    success: "兩個尼龍繩圈各自完成一整圈並返回原本起點；後到隊伍必須快過現場最快時間。",
  },
  {
    id: "P6",
    title: "纜索貨運站",
    game: "繩控托盤運送層層疊",
    materials: ["層層疊 1 套", "連控制繩的貨運托盤 1 個", "雪糕筒或地標 3 個"],
    rules: [
      "工作員先在托盤上砌好層層疊塔；每位隊員只可握住自己的一條控制繩。",
      "全隊用繩索保持托盤平衡，帶着層層疊塔依次繞過所有地標到達終點。",
      "不可直接用手或身體接觸托盤及層層疊，亦不可跳過指定路線。",
      "層層疊倒下便由工作員重新砌好並返回起點，計時不會暫停。",
    ],
    success: "托盤、全隊及仍然企穩的層層疊塔到達終點並保持 3 秒；後到隊伍必須快過現場最快時間。",
  },
];
...
export const CARGO_ORDER_ROUNDS = [
  {
    ...
    constraints: ["醫療箱一定第一", "文件袋在飲用水之前", "飲用水在工具箱之前", "工具箱緊接在後備電池之前", "易碎儀器一定最後"],
  },
  {
    items: ["救生圈", "雨具", "繩索", "電筒", "食物箱", "睡袋"],
    solution: ["救生圈", "雨具", "繩索", "電筒", "食物箱", "睡袋"],
    constraints: ["救生圈一定第一", "雨具緊接在繩索之前", "繩索在電筒之前", "電筒在食物箱之前", "睡袋一定最後"],
  },
  {
    items: ["通訊機", "藥物箱", "淡水", "乾糧", "維修包", "後備纜索"],
    solution: ["通訊機", "藥物箱", "淡水", "乾糧", "維修包", "後備纜索"],
    constraints: ["通訊機一定第一", "藥物箱在淡水之前", "淡水緊接乾糧", "乾糧在維修包之前", "維修包在後備纜索之前，後備纜索一定最後"],
  },
  {
    items: ["船員名冊", "救生衣", "照明燈", "訊號旗", "工具袋", "垃圾袋"],
    solution: ["船員名冊", "救生衣", "照明燈", "訊號旗", "工具袋", "垃圾袋"],
    constraints: ["船員名冊一定第一", "救生衣在照明燈之前", "訊號旗緊接照明燈之後", "訊號旗在工具袋之前", "垃圾袋一定最後"],
  },
  {
    items: ["航海圖", "指南針", "電池箱", "手提電台", "防水布", "清潔用品"],
    solution: ["航海圖", "指南針", "電池箱", "手提電台", "防水布", "清潔用品"],
    constraints: ["航海圖一定第一", "指南針在電池箱之前", "電池箱緊接手提電台", "手提電台在防水布之前", "防水布在清潔用品之前，清潔用品一定最後"],
  },
  {
    items: ["乘客清單", "急救包", "飲品箱", "零食箱", "後備雨衣", "空紙箱"],
    solution: ["乘客清單", "急救包", "飲品箱", "零食箱", "後備雨衣", "空紙箱"],
    constraints: ["乘客清單一定第一", "急救包在飲品箱之前", "飲品箱緊接零食箱", "零食箱在後備雨衣之前", "空紙箱一定最後"],
  },
  {
    items: ["登船證", "醫療氧氣", "毛毯", "樽裝水", "工具盒", "回收袋"],
    solution: ["登船證", "醫療氧氣", "毛毯", "樽裝水", "工具盒", "回收袋"],
    constraints: ["登船證一定第一", "醫療氧氣在毛毯之前", "毛毯緊接樽裝水", "樽裝水在工具盒之前", "回收袋一定最後"],
  },
  {
    items: ["泊位文件", "滅火筒", "救援繩", "警示燈", "防滑墊", "空水桶"],
    solution: ["泊位文件", "滅火筒", "救援繩", "警示燈", "防滑墊", "空水桶"],
    constraints: ["泊位文件一定第一", "滅火筒在救援繩之前", "警示燈緊接救援繩之後", "警示燈在防滑墊之前", "空水桶一定最後"],
  },
  {
    items: ["天氣報告", "望遠鏡", "防水電台", "充電器", "帆布", "清潔布"],
    solution: ["天氣報告", "望遠鏡", "防水電台", "充電器", "帆布", "清潔布"],
    constraints: ["天氣報告一定第一", "望遠鏡在防水電台之前", "防水電台緊接充電器", "充電器在帆布之前", "清潔布一定最後"],
  },
  {
